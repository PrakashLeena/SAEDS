                ...
                >
                  ...
                  {slide.cta.primary.link.startsWith('#') || slide.cta.primary.link === '/join' ? (
                    <button
                      ...
                      className="btn-primary bg-primary-600 text-white px-2 py-1 sm:px-5 sm:py-2.5 md:px-6 md:py-3 rounded text-[8px] sm:text-sm font-semibold hover:bg-primary-700 transition-all hover:scale-105 text-center shadow-lg relative z-10 touch-manipulation whitespace-nowrap"
                    >
                  ...
                  {slide.cta.secondary.link.startsWith('#') || slide.cta.secondary.link === '/join' ? (
                    <button
                      ...
                      className="btn-secondary bg-white/20 backdrop-blur-sm text-white px-2 py-1 sm:px-5 sm:py-2.5 md:px-6 md:py-3 rounded text-[8px] sm:text-sm font-semibold hover:bg-white/30 transition-all hover:scale-105 text-center border border-white/50 shadow-lg touch-manipulation whitespace-nowrap"
                    >
